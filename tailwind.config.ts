  ...
  theme: {
    extend: {
      colors: {
        ...
        gblue: { DEFAULT: "var(--g-blue)", soft: "var(--g-blue-soft)" },
        gred: { DEFAULT: "var(--g-red)", soft: "var(--g-red-soft)" },
        gyellow: { DEFAULT: "var(--g-yellow)", soft: "var(--g-yellow-soft)" },
        ggreen: { DEFAULT: "var(--g-green)", soft: "var(--g-green-soft)" },
        canvas: "var(--canvas)",
        surface: "var(--surface)",
