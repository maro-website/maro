...
export function projectAssetErrorMessage(error: unknown): string {
  ...
  if (code === "file-too-large" || code === "too-large") return "Imazhi duhet të jetë maksimumi 5 MB.";
  if (code === "invalid-file-type" || code === "unsupported-format") return "Zgjidh një imazh PNG, JPG ose WebP.";
