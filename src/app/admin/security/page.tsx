      ...
      <div className="mx-auto max-w-5xl px-5 py-8 sm:px-8">
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          <div>
            <button
              ...
              className="mb-2 inline-flex items-center gap-1.5 text-[13px] font-semibold text-ink-3 hover:text-ink"
            >
              <ArrowLeft className="h-4 w-4" /> Admin
            </button>
            <h1 className="flex items-center gap-2 text-[28px] font-semibold tracking-tight text-ink">
              <Shield className="h-7 w-7 text-brand" /> Siguria & Kostot
            </h1>
            <p className="mt-1 text-[14px] text-ink-3">
              Monitorim shpenzimesh, kufizimesh dhe kontrolle emergjente.
            </p>
          </div>
          <div className="flex items-center gap-3">
            ...
            />
            <Badge tone={c?.aiPaused ? "neutral" : "success"}>
              {c?.aiPaused ? "Pauzuar" : "Aktiv"}
            </Badge>
          </div>
        </div>
        ...
        {loading || !data ? (
          ...
          <div className="grid gap-6">
            ...
            {c &&
              c.hourlySpendUsd >= (c.limits.hourlySpendUsd ?? 100) * 0.8 && (
...
function StatCard({
  ...
  return (
    <div className="rounded-2xl bg-surface p-5">
      ...
      <div className="mt-2 text-[28px] font-semibold tracking-tight text-ink">{value}</div>
