      ...
      <div className="relative h-full overflow-y-auto scroll-thin">
        ...
        <div className="mx-auto w-full max-w-4xl px-5 py-14 sm:px-8 sm:py-20">
          ...
          <motion.h1
            ...
            className="text-balance text-[clamp(38px,7vw,68px)] font-extrabold leading-[1.01] tracking-[-0.045em] text-ink"
          >
            {firstName ? `Mirë se erdhe, ${firstName}.` : "Krijo çdo gjë"}
            <br />
            <span className="text-accent">me një fjali.</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-6 max-w-xl text-[18px] leading-relaxed text-ink-2"
          >
            Një vend i vetëm për website, logo dhe reklama. Të gjitha me AI, të gjitha
            me kredite. Zgjidh një tool dhe fillo.
          </motion.p>

          {/* TOOLS (horizontal rows, stacked down) */}
          ...
          <div className="mt-16 text-[13px] text-ink-3">
  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 flex-1">
        <span className="block text-[19px] font-extrabold tracking-[-0.02em] text-ink sm:text-[21px]">
          {tool.name}
        </span>
