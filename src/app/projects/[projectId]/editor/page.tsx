  ...
  return (
    <AppShell hideFooter>
      ...
      <EditorProvider project={project}>
        ...
        <div className="grid min-h-0 flex-1 place-items-center px-6 lg:hidden">
          <div className="max-w-sm text-center">
            ...
            <p className="mt-2 text-[14px] leading-relaxed text-ink-2">
              Për eksperiencën më të mirë të editimit, hape maro në desktop. Nga telefoni mund të shohësh krijimet dhe
              llogarinë.
            </p>
            <Button className="mt-5" onClick={() => router.push("/krijimet")}>
              Kthehu te krijimet
            </Button>
          </div>
        </div>
